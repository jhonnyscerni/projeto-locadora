...
public class AluguelDAO implements Serializable {
	...
	public List<Aluguel> buscarTodos(){
		return manager.createQuery("from Aluguel", Aluguel.class).getResultList();
	}
	...
	public List<Aluguel> buscarPorDataDeEntregaEModeloCarro(Date dataEntrega,
		...
		if (modeloCarro != null) {
			ParameterExpression<ModeloCarro> modeloExpression = builder.parameter(ModeloCarro.class, "modeloCarro");
